...
so you can work on one branch then seamlessly switch to another branch without clobbering the changes you have made in the current branch.
...
Depending on your git setup, you may want other long-lived worktrees like `develop` or `release`.
