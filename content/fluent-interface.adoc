...
The assertJ example is easy to read because:

* the syntax almost reads like a sentence. Someone that has not seen code before can have a rough understanding of what is happening
...
* minimal code is required to add another assertion
...
You can create your own assertJ assertions.
