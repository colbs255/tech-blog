...
. Each state has a builder that it passes around
    . Little more code but more flexible
. Bunch of innerclasses with access to the static variable
    . Less code but less flexible
